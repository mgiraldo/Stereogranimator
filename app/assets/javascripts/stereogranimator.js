...
function drawCorners() {
  ...
  for (i=0;i<8;++i) {
    ...
    // draw arrows in corner
    if (i==0 || i==3 || i==4 || i==7) {
      // slash down \
      crnr.graphics.moveTo(-CORNER_OFFSET+pad,-CORNER_OFFSET+pad).lineTo(-CORNER_OFFSET+pad+miniarrow,-CORNER_OFFSET+pad);
      crnr.graphics.moveTo(-CORNER_OFFSET+pad,-CORNER_OFFSET+pad).lineTo(-CORNER_OFFSET+pad,-CORNER_OFFSET+pad+miniarrow);
      crnr.graphics.moveTo(CORNER_OFFSET-pad,CORNER_OFFSET-pad-miniarrow).lineTo(CORNER_OFFSET-pad,CORNER_OFFSET-pad).lineTo(CORNER_OFFSET-pad-miniarrow,CORNER_OFFSET-pad);
      crnr.graphics.moveTo(-CORNER_OFFSET+pad,-CORNER_OFFSET+pad).lineTo(CORNER_OFFSET-pad,CORNER_OFFSET-pad);
    } else {
      // slash up /
      crnr.graphics.moveTo(CORNER_OFFSET-pad-miniarrow,-CORNER_OFFSET+pad).lineTo(CORNER_OFFSET-pad,-CORNER_OFFSET+pad).lineTo(CORNER_OFFSET-pad,-CORNER_OFFSET+pad+miniarrow);
      crnr.graphics.moveTo(-CORNER_OFFSET+pad,CORNER_OFFSET-pad-miniarrow).lineTo(-CORNER_OFFSET+pad,CORNER_OFFSET-pad).lineTo(-CORNER_OFFSET+pad+miniarrow,CORNER_OFFSET-pad);
      crnr.graphics.moveTo(-CORNER_OFFSET+pad,CORNER_OFFSET-pad).lineTo(CORNER_OFFSET-pad,-CORNER_OFFSET+pad);
    }
    // end arrows
