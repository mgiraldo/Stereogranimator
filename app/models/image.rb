class Image < ActiveRecord::Base
  ...
  def self.flickr_sets
    ...
    [
      ...
      {:id=>4, :set_id=>"72157668179459936", :owner_id=>"35740357@N03", :name=>"The U.S. National Archives", :baseurl=>"https://www.flickr.com/photos/usnationalarchives/", :homeurl=>"http://www.archives.gov/research/"}
    ]
  end
