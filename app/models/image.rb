class Image < ActiveRecord::Base
  ...
  def self.flickr_sets
    ...
    [
      ...
      {:id=>7, :set_id=>"72157671356764974", :owner_id=>"114839158@N08", :name=>"Fondazione del Monte", :baseurl=>"https://www.flickr.com/photos/114839158@N08/", :homeurl=>"http://fondazionedelmonte.it/"}
    ]
  end
